      ...
      if (response == true) {
        ...
        return dao.getUserDetails(query).then(async (userData) => {
          ...
          if (Number(balance) > Number(details.amount)) {
            ...
            {
              if(gateway=="cashfree"||gateway=="paytme")
            {
            ...
            else if(gateway=="paytme"||gateway=="cashfree")
            {
 ...
 .then((response)=>{
   if(response==true)
   {
       ...
       .then((userDetails)=>{
           ...
           if(userDetails)
           {
               //console.log("data",userDetails.payoutsData.last24hrSuccess,userDetails.payoutsData.last24hrTotal)
               let response ={
